...
<input type="hidden" id="status" value="<%= request.getAttribute("status") %>">
					...
					try{
						...
						while(rs1.next()){
							...
							if(rs2.next()){
								...
								request.setAttribute("fromuser", friendID);
						...
						<tr>
							...
							<td>
		                        <button id="plot-btn" onclick="window.location='../SendPlot.jsp'">Send Plot</button>								

							</td>
							<td>
								<form method="POST" action="../unpeer">
		                            <input type="hidden" name="fromid" value="<%= request.getAttribute("fromuser") %>">
    ...
    <script type="text/javascript">
    	...
    	if (status == "duplicate") {
    		swal("Oops", "You have already sent peer request", "success");
    	}
    </script>
